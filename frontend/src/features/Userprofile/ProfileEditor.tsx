...
/* TODO: possibly refactor, split into more modules. It's kinda messy. */
const ProfileEditor = forwardRef<HTMLDivElement, ProfileEditorProps>(
  ({ closeModal }, ref) => {
    ...
    const passwordTooShort =
      passwordInput.length < 8 && passwordInput.length > 0;
    ...
    return (
      <Container
        className="content modal-content profile-editor"
        maxWidth="sm"
        ref={ref}
      ...
      >
        <h1 id="profile-editor-title">Edit your profile:</h1>
        <FormControl>
